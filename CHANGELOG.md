...
There are no code changes since version 5.3.3. This release was made to help redirect you to the latest version. Please visit <https://github.com/brightcove/brightcove-player-sdk-ios> for full details about installing and using the latest version.

### Breaking Changes
* This release, version 5.3.4, is the final version to appear on cocoapods.org. If you are looking for the latest version of the Brightcove Player SDK, please visit <https://github.com/brightcove/brightcove-player-sdk-ios>.
* You can still install the latest version using CocoaPods, but the Brightcove Player SDK podspecs will no longer be hosted on cocoapods.org. Starting with version 6.0 (released July 2017), Brightcove Player SDK podspecs are hosted in a new private podspecs repository at <https://github.com/brightcove/BrightcoveSpecs.git>
* For CocoaPods installations, newer versions will require changing the Brightcove podspec names in your podfiles, along with changing the source podspec repositories from BCOVSpecs.git to BrightcoveSpecs.git.
